<script>
    import {chosenActor,showActorsList,moviesByActor} from "../stores/stores.js"
            ...
            {#each array as item}
                <stackLayout style="margin-right:30;" on:tap={useFunction ? setActor(item.id) : ""}>
                    <flexBoxLayout style="height:70; width:70;">
                        <image  stretch="aspectFill" class="thumb img-circle"  style="width:100%; height:100%; " src={"https://image.tmdb.org/t/p/w185"+ item.profile_path} />
                    </flexBoxLayout>
